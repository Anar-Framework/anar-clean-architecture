...
import af.gov.anar.application.ProvinceService;
...
public class ProvinceController {
    ...
    @GetMapping(value = "/{id}")
    public ResponseEntity<Province> findOne(@PathVariable(name = "id", required = true) long id) {
    ...
    @PutMapping(value = "/{id}")
    public ResponseEntity<Province> update(@PathVariable(name = "id", required = true) long id,
